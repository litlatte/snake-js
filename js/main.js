...
var message_box = document.getElementById('game-message-box')//Gets the label where the messages will be shown, this label would be preferrable at the button
...
game = new Game(cvWidth, cvHeight, block_sz, Math.floor(block_sz), context, points, points_record, buttonsContainer, message_box) // Instance of Game(canvas width in blocks, canvas height in blocks, block size, margin, canvas context, buttonsContainer) "buttonsContainer" is optional
